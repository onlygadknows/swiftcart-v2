const ProductLoader = () => {
  return (
    <div className="w-full mb-5 flex items-center justify-between">
      <div className="h-auto w-full mx-auto max-w-2xl px-4 sm:px-6 sm:flex sm:justify-between sm:flex-col sm:gap-2 md:gap-1 lg:grid-rows-1 lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:gap-5">
